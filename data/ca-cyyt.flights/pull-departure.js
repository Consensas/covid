/*
 *  data/ca-cyyt.flights/pull-departure.js
 *
 *  David Janes
 *  Consensas
 *  2020-04-05
...
_.promise()
    ...
    .then(fetch.document.get("https://stjohnsairport.com/deptable.php?v=202004040756"))
    .make(sd => {
        sd.json = []
        const $ = cheerio.load(sd.document)
        $("table").each((x, e) => {
            sd.json.push(_util.normalize.object(_util.cheerio.table($, $(e))))
        })
    })
