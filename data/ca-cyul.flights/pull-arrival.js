/*
 *  data/ca-cyul.flights/pull-arrival.js
 *
 *  David Janes
 *  Consensas
 *  2020-04-05
...
_.promise()
    ...
    .then(fetch.json.get("https://www.admtl.com/en/admtldata/api/flight?type=arrival&sort=field_planned&direction=ASC&rule=24h"))
